...
- [ArrayList核心源码](#arraylist核心源码)
        - [<font face="楷体" id="1" id="5">ArrayList源码分析</font>](#font-face楷体-id1-id5arraylist源码分析font)
            - [System.arraycopy()和Arrays.copyOf()方法](#systemarraycopy和arrayscopyof方法)
                - [两者联系与区别](#两者联系与区别)
            - [ArrayList 核心扩容技术](#arraylist-核心扩容技术)
            - [内部类](#内部类)
        - [<font face="楷体" id="6"> ArrayList经典Demo</font>](#font-face楷体-id6-arraylist经典demofont)
