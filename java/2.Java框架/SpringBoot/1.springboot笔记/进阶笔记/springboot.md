...
- [1. 学习目标](#1-学习目标)
- [2. 了解SpringBoot](#2-了解springboot)
    - [2.1. 什么是SpringBoot](#21-什么是springboot)
    - [2.2. 为什么要学习SpringBoot](#22-为什么要学习springboot)
    - [2.3. SpringBoot的特点](#23-springboot的特点)
- [3. 快速入门](#3-快速入门)
    - [3.1. 创建工程](#31-创建工程)
    - [3.2. 引入依赖](#32-引入依赖)
    - [3.3. 编写HelloController](#33-编写hellocontroller)
    - [3.4. 启动测试](#34-启动测试)
    - [3.5. 详解](#35-详解)
        - [3.5.1. 启动器](#351-启动器)
        - [3.5.2. @EnableAutoConfiguration](#352-enableautoconfiguration)
    - [3.6. 优化入门程序](#36-优化入门程序)
        - [3.6.1. 添加引导类](#361-添加引导类)
        - [3.6.2. @ComponentScan](#362-componentscan)
        - [3.6.3. @SpringBootApplication](#363-springbootapplication)
        - [3.6.4. @SpringBootConfiguration](#364-springbootconfiguration)
- [4. 默认配置原理](#4-默认配置原理)
    - [4.1. 回顾历史](#41-回顾历史)
    - [4.2. 尝试java配置](#42-尝试java配置)
        - [4.2.1. 引入依赖](#421-引入依赖)
        - [4.2.2. 添加jdbc.properties](#422-添加jdbcproperties)
        - [4.2.3. 配置数据源](#423-配置数据源)
        - [4.2.4. 测试](#424-测试)
    - [4.3. SpringBoot的属性注入](#43-springboot的属性注入)
    - [4.4. 更优雅的注入](#44-更优雅的注入)
    - [4.5. SpringBoot中的默认配置](#45-springboot中的默认配置)
    - [4.6. 总结](#46-总结)
- [5. SpringBoot实战](#5-springboot实战)
    - [5.1. 创建工程](#51-创建工程)
    - [5.2. 编写基本代码](#52-编写基本代码)
    - [5.3. 整合SpringMVC](#53-整合springmvc)
        - [5.3.1. 修改端口](#531-修改端口)
        - [5.3.2. 访问静态资源](#532-访问静态资源)
        - [5.3.3. 添加拦截器](#533-添加拦截器)
    - [5.4. 整合连接池](#54-整合连接池)
    - [5.5. 整合mybatis](#55-整合mybatis)
        - [5.5.1. mybatis](#551-mybatis)
        - [5.5.2. 通用mapper](#552-通用mapper)
    - [5.6. 整合事务](#56-整合事务)
    - [5.7. 启动测试](#57-启动测试)
    - [5.8. 完整项目结构](#58-完整项目结构)
- [6. Thymeleaf快速入门](#6-thymeleaf快速入门)
    - [6.1. 为什么是Thymeleaf？](#61-为什么是thymeleaf)
    - [6.2. 提供数据](#62-提供数据)
    - [6.3. 引入启动器](#63-引入启动器)
    - [6.4. 静态页面](#64-静态页面)
    - [6.5. 测试](#65-测试)
