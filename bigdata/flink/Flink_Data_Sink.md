...
### 3.4 测试结果
【注意】思路是：kafka生产者向flink-stream-in-topic主题发送消息，java对消息进行处理并发送至flink-stream-out-topic主题，消费者从flink-stream-out-topic主题读取消息。

在 Kafka 生产者上发送消息到 Flink 程序，观察 Flink 程序转换后的输出情况，具体如下：

<div align="center"> <img src="imgs/note/flink-kafka-producer-consumer.png"/> </div>
...
<div align="center"> <img src="imgs/note/flink-richsink.png"/> </div>
...
<div align="center"> <img src="imgs/note/flink-mysql-sink.png"/> </div>
