...
<div align="center"> <img src="imgs/note/flink-RichParallelSourceFunction.png"/> </div>
...
<div align="center"> <img src="imgs/note/flink-kafka-datasource-producer.png"/> </div>
程序控制台的输出如下：

<div align="center"> <img src="imgs/note/flink-kafka-datasource-console.png"/> </div>
可以看到已经成功接收并打印出相关的数据。
